...
entryPointNames.forEach(entryPointName => {
  externals["@newtify/" + entryPointName] = {
    this: ["newtify", entryPointName]
  };
});

const wpDependencies = ["components", "element", "data"];
